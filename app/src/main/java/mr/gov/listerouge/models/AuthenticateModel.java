...
public class AuthenticateModel {
    ...
    private String rightmiddlefingerl;
    ...
    public String getRightmiddlefingerl() {
        return rightmiddlefingerl;
    }

    public void setRightmiddlefingerl(String rightmiddlefingerl) {
        this.rightmiddlefingerl = rightmiddlefingerl;
    }
