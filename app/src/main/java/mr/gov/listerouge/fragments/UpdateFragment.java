...
public class UpdateFragment extends Fragment {
    ...
    private EditText nniedit,requrestidedit,nudedit;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        nniedit = view.findViewById(R.id.personnenni);
        ...
        buttonAdd.setOnClickListener(v -> {
            ...
            String nnipersonne = nniedit.getText().toString().trim();
        ...
        if (getArguments() != null) {
            personneid = getArguments().getString("id");
    ...
    private void updateLr(String entity, String appname, String appversion, String devicesn,
                          ...
                          String conduitContact, String pieceJustifBase64,
                          String nud,String requestid,String matricule,String photo) {
        if(pieceJustifBase64==null){
            pieceJustifBase64="";
        }
        CreateList list = new CreateList(loca,nni,description,conduitContact,pieceJustifBase64,nud,requestid,"","");
